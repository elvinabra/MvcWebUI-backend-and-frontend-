...
new Product(){Name= "Canon EOS 2000D Kit 18-55 ", Description="Guaranteed", Price= 400, Stock= 52, IsApproved= true, CategoryId= 1, IsHome=true, Image="Samsung Galaxy Fold SM-F900F black.jpg"},
